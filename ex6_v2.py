...
x = f"here are {types_of_people} types o people." # con f de format al inicio del string puedo
...
y = "Those who know {binary} and those who {do_not}." # al pasar f de format puedo meter todas las 
...
#previament
print(y) # imprimir la vriable y que ademas esta jalando con f de format variables definidas 
#previamente

print(f"I said: {x}") # con f e format estoy jalando la variable x, que a su vez esta jalando otra variable
...
joke_evaluation = "Isn't that oke so funny?! {}" # defino una variable con un string que contiene {}
...
w = "This is the left side of.." #creo na varable con un string
